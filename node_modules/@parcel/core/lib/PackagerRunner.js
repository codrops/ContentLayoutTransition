...
class PackagerRunner {
  ...
  async getCacheKey(bundle, bundleGraph, configs, bundleConfigs, invalidations) {
    ...
    return (0, _rust().hashString)(_constants.PARCEL_VERSION + devDepHashes + invalidationHash + bundle.target.publicUrl + bundleGraph.getHash(bundle) + JSON.stringify(configResults) + JSON.stringify(globalInfoResults) + this.options.mode);
  }
